...
public class ChatContext_Create_SetActionMicroflow extends CustomJavaAction<IMendixObject>
{
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		try {
		    ...
		    ProviderConfig providerConfig = createAndSetProviderConfigSpecialization();
	...
	private ProviderConfig createAndSetProviderConfigSpecialization() throws Exception {
		// Create an instance of the specialized ProviderConfig object
		IMendixObject providerConfigSpecialization = Core.instantiate(getContext(), ProviderConfigSpecialization);
		...
		ProviderConfig providerConfig = ProviderConfig.initialize(getContext(), providerConfigSpecialization);
