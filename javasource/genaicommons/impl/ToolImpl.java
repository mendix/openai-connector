...
public class ToolImpl {
	...
	public static Tool createTool(IContext context, String functionMicroflow, String functionName, String functionDescription, ToolCollection toolCollection) throws CoreException {
		Function tool = new Function(context);
		tool.setMicroflow(functionMicroflow);
		tool.setName(functionName);	
		tool.setDescription(functionDescription); //Optional parameter
