...
public class ChatCompletionsMessageRequestImpl {
	...
	public static List<ChatCompletionsMessageRequest> retrieveMessageListByRole (ChatCompletionsMessages chatCompletionsMessages, ENUM_Role filterByRole, IContext context){
	
		List<ChatCompletionsMessageRequest> messageList = Core.retrieveByPath(context, chatCompletionsMessages.getMendixObject(), ChatCompletionsMessageRequest.MemberNames.ChatCompletionsMessageRequest_ChatCompletionsMessages.toString())
				.stream()
				.filter(mxObject -> {
